...
function FormFicha({ fichaId, onClose }: { fichaId?: number; onClose: () => void }) {
  ...
  const submeter = () => {
    ...
    const dados = { nome: nome.trim(), familia, secaoMenu: secaoMenu || undefined, precoVenda: preco || undefined, unidadePrecoVenda, quantidadeMinimaVenda: minimo, componentes };
